...
create or replace storage integration s3_int_orc
  type = external_stage
  storage_provider = s3
  enabled = true
  storage_aws_role_arn = 'arn:aws:iam::993732589604:role/Snowflake-role'
  storage_allowed_locations = ('s3://snowflake-data-2212/orc/');
  
  desc integration s3_int_orc;
...
create or replace stage INGEST_DATA.public.ext_orc_stage_pipe
  URL = 's3://snowflake-data-2212/orc/'
  STORAGE_INTEGRATION = s3_int_orc
